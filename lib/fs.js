...
class GoogleDriveItem {
    ...
    async get({params = {}} = {}) {
        ...
        const res = await util.promisify(this._context._drive.files.get)(params);
    ...
    async create({params = {}, resource = {}, id, name, mimeType, body} = {}) {
        ...
        const res = await util.promisify(this._context._drive.files.create)(params);
    ...
    async delete({params = {}} = {}) {
        ...
        await util.promisify(this._context._drive.files.delete)(params);
    ...
    async update({params = {}, resource = {}, id, name, mimeType, body} = {}) {
        ...
        const res = await util.promisify(this._context._drive.files.update)(params);
...
class GoogleDriveFile extends GoogleDriveItem {
    ...
    async copy({params = {}, resource = {}, id, name, mimeType} = {}) {
        ...
        const res = await util.promisify(this._context._drive.files.copy)(params);
...
class GoogleDriveFolder extends GoogleDriveItem {
    ...
    async getChildren({params = {}, query} = {}) {
        ...
        params.fields = `kind,nextPageToken,files(${fields}),incompleteSearch`;

        const items = [];

        for (;;) {
            const res = await util.promisify(this._context._drive.files.list)(params);
